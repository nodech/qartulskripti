...
(function() {
  ...
  grammar = {
    ...
    WhileSource: [
      ...
      }), o('სანამ Expression', function() {
        return new While($2, {
          invert: true
        });
      }), o('სანამ Expression WHEN Expression', function() {
        return new While($2, {
          invert: true,
          guard: $4
        });
  ...
  operators = [['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', 'LOGIC'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'სანამ', 'LOOP', 'SUPER', 'CLASS'], ['left', 'POST_IF']];
