...
(function() {
  var BOM, BOOL, CALLABLE, CODE, COFFEE_ALIASES, COFFEE_ALIAS_MAP, COFFEE_KEYWORDS, COMMENT, COMPARE, COMPOUND_ASSIGN, GEORGIAN_ALIASES, GEORGIAN_ALIAS_MAP, HEREDOC, HEREDOC_ILLEGAL, HEREDOC_INDENT, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, INVERSES, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LINE_BREAK, LINE_CONTINUER, LOGIC, Lexer, MATH, MULTILINER, MULTI_DENT, NOT_REGEX, NOT_SPACED_REGEX, NUMBER, OPERATOR, REGEX, RELATION, RESERVED, Rewriter, SHIFT, SIMPLESTR, STRICT_PROSCRIBED, TRAILING_SPACES, UNARY, WHITESPACE, compact, count, invertLiterate, key, last, locationDataToString, repeat, starts, throwSyntaxError, _ref, _ref1,
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      if (__indexOf.call(GEORGIAN_ALIASES, id) >= 0) {
  ...
  GEORGIAN_ALIASES = (function() {
    var _results;
    _results = [];
    for (key in GEORGIAN_ALIAS_MAP) {
      _results.push(key);
    }
    return _results;
  })();
