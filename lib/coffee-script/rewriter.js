...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitBracesAndParens = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        if (__indexOf.call(IMPLICIT_FUNC, tag) >= 0 && this.matchTags(i + 1, 'INDENT', null, ':') && !this.findTagsBackwards(i, ['CLASS', 'EXTENDS', 'IF', 'CATCH', 'SWITCH', 'LEADING_WHEN', 'FOR', 'WHILE', 'როცა', 'UNTIL'])) {
          startImplicitCall(i + 1);
  ...
  IMPLICIT_END = ['POST_IF', 'FOR', 'WHILE', 'როცა', 'UNTIL', 'WHEN', 'BY', 'LOOP', 'TERMINATOR'];
