...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitBracesAndParens = function() {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        if (__indexOf.call(IMPLICIT_FUNC, tag) >= 0 && this.matchTags(i + 1, 'INDENT', null, ':') && !this.findTagsBackwards(i, ['CLASS', 'EXTENDS', 'IF', 'CATCH', 'SWITCH', 'LEADING_WHEN', 'FOR', 'WHILE', 'UNTIL', 'სანამ'])) {
          startImplicitCall(i + 1);
  ...
  IMPLICIT_END = ['POST_IF', 'FOR', 'WHILE', 'UNTIL', 'სანამ', 'WHEN', 'BY', 'LOOP', 'TERMINATOR'];
